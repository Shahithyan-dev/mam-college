  ...
  return (
    <div className="py-20 max-w-7xl mx-auto px-4 sm:px-6 min-h-[60vh]">
      <div className="text-center mb-16">
        ...
        <p className="mt-6 text-xl text-brand-text/80 max-w-2xl mx-auto">Join our faculty and staff to help shape the future of engineering education.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start flex-col sm:flex-row gap-4">
              <div>
                ...
                <div className="mt-3 flex gap-4 text-sm text-brand-text/80">
        ...
        <div className="mt-12 bg-brand-base p-6 rounded-xl text-center">
          <p className="text-brand-text/80">Don't see a position that matches your profile? Send your resume to <a href="mailto:hr@mamce.org" className="text-brand-primary font-bold hover:underline">hr@mamce.org</a> and we will contact you if a relevant position opens up.</p>
        </div>
      </div>
    </div>
  );
